...
public void VERIFY_THAT_USER_MENU_IS_CLICKED_SUCCESSFULLY()  throws IOException, InterruptedException {
	Thread.sleep(3000);
...
public void  VERIFY_THAT_USER_IS_NAVIGATED_INTO_ADD_USER_SECTION_WHEN_CLICK_ON_ADD_USER_BUTTON()  throws IOException, InterruptedException {
...
public void  VERIFY_THAT_USER_ENTER_THE_USERNAME_IN_USERNAME_FIELD()  throws IOException, InterruptedException {
	Thread.sleep(3000);
...
public void  VERIFY_THAT_USER_ABLE_TO_ENTER_MAILID_SUCCESSFULLY()  throws IOException, InterruptedException {
...
public void VERIFY_THAT_USER_ABLE_TO_SELECT_THE_INDIA_Dial_CODE()throws IOException, InterruptedException{
	...
	for(WebElement Option:Options)
	{
		...
		public void  VERIFY_THAT_USER_IS_ABLE_TO_ENTER_THE_10_DIGIT_MOBILE_NUMBER_ON_MOBILE_NUMBER_FIELD ()  throws IOException, InterruptedException {
	...
	@Test(priority=8, enabled=true)
			public void VERIFY_THAT_USER_IS_ABLE_TO_SELECT_THE_LOCATION_LEVEL_AS_COUNTRY_IN_LEVEL_DROPDOWN ()throws IOException, InterruptedException{
	...
	public void VERIFY_THAT_USER_IS_ABLE_TO_SELECT_THE_LOCATION_IN_LOCATION_FIELD ()throws IOException, InterruptedException{
	...
	public void VERIFY_THAT_DEFAULT_PASSWORD_DISPLAYED_AS_ENCRYPED_FORMAT_IN_PASSWORD_FIELD()throws IOException, InterruptedException{
	...
	public void VERIFY_THAT_CONFIRM_PASSWORD_IS_FILLED_WITH_DEFAULT_PASSWORD()throws IOException, InterruptedException{
	...
	public void VERIFY_THAT_NEW_USER_IS_CREATED_SUCCESSFULLY_BY_CLICKING_THE_SUBMIT_BUTTON()throws IOException, InterruptedException{
		...
		Assert.assertTrue(expectedmessage.contains(actualsuccessmessage),"Popup message does not contain the expected text.");
		System.out.println(actualsuccessmessage);
		}
