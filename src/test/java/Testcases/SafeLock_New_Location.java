...
public class SafeLock_New_Location extends Basesetup {
	 ...
	 public static WebDriver driver;
	    ...
	    public void VERIFY_THAT_ADD_LOCATION_PAGE_IS_NAVIGATED_BY_CLICKING_ON_PLUS_ICON() throws IOException, InterruptedException {
	        clickElement(NewLocation.Plusicon);
	        System.out.println("SafeLock New Location Page Appeared Successfully");
	    }

	    @Test(priority = 4, enabled = true)
	    public void VERIFY_THAT_ABLE_TO_SELECT_THE_COUNTRY_ON_THE_ADD_LOCATION_POPUP() throws IOException, InterruptedException {
	    ...
	    public void VERIFY_THAT_ABLE_TO_ENTER_THE_LOCATION_NAME_ALONG_WITH_STATE_NAME() throws IOException, InterruptedException {
	        String LocationName = prop.getProperty("LocationName");
	        NewLocation.LocationName.sendKeys(LocationName);
	        System.out.println("LocationName entered Successfully");
	    }

	    @Test(priority = 6, enabled = true)
	    public void VERIFY_THAT_NEW_LOCATION_ADDED_SUCCESSFULLY_BY_CLICK_ON_SUBMIT() throws IOException, InterruptedException {
	        ...
	        Thread.sleep(5000);
	        clickElement(NewLocation.closeicon);
	        System.out.println("Popupclosed success");	   
	       }
	    
	    @Test(priority = 7, enabled = true)
		
	    public void VERIFY_THAT_CREATED_LOCATION_DISPLAYED_IN_LOCATION_GRID_SECTION() throws IOException , InterruptedException {
	    	Actions Search = new Actions(driver);
		    Search.sendKeys(Keys.TAB).perform();
	        System.out.println("tab success");	        
	        String search = prop.getProperty("LocationName");
	      ...
	      /*  if (search != null && !search.isEmpty()) {
	            ...
	            System.out.println("Search term is null or empty");
	    ...
	    public void VERIFY_THAT_LOCK_MAPPING_POPOUP_APPEARED_BY_CLICK_ON_LOCK_MAPPING_BUTTON () throws IOException, InterruptedException {
            Thread.sleep(5000);
      ...
      @Test(priority = 9, enabled = true)
	    ...
	    public void VERIFY_THAT_USER_IS_ENTER_THE_LOCK_NAME_SUCCESSFULLY  () throws IOException, InterruptedException {
    	  String EnterLockName = prop.getProperty("EnterLockName");
      ...
      public void  VERIFY_THAT_USER_IS_ABLE_TO_SELECT_THE_LOCK_ID_FROM_THE_DROP_DOWN_SUCCESSFULLY () throws IOException, InterruptedException {
    	
    	Actions lockid = new Actions(driver);
    	lockid.sendKeys(Keys.TAB).perform();
    	  String EnterLockid = prop.getProperty("EnterLockid");
      ...
      public void VERIFY_THAT_LOCK_MAPPED_WITH_SELECTED_LOCATION_BY_CLICK_ON_SUBMIT() throws IOException, InterruptedException {
